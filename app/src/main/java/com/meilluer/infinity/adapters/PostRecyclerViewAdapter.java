...
import com.meilluer.infinity.FetchVideoLinkListener;
import com.meilluer.infinity.R;
import com.meilluer.infinity.SaveMemoryCenterInisdeDownsampleStrategy;
...
import com.meilluer.infinity.apis.RedgifsAPI;
import com.meilluer.infinity.apis.StreamableAPI;
import com.meilluer.infinity.bottomsheetfragments.PostOptionsBottomSheetFragment;
import com.meilluer.infinity.bottomsheetfragments.ShareBottomSheetFragment;
import com.meilluer.infinity.customtheme.CustomThemeWrapper;
import com.meilluer.infinity.customviews.AspectRatioGifImageView;
import com.meilluer.infinity.customviews.LinearLayoutManagerBugFixed;
import com.meilluer.infinity.databinding.ItemPostCard2GalleryTypeBinding;
import com.meilluer.infinity.databinding.ItemPostCard2TextBinding;
import com.meilluer.infinity.databinding.ItemPostCard2VideoAutoplayBinding;
import com.meilluer.infinity.databinding.ItemPostCard2VideoAutoplayLegacyControllerBinding;
import com.meilluer.infinity.databinding.ItemPostCard2WithPreviewBinding;
import com.meilluer.infinity.databinding.ItemPostCard3GalleryTypeBinding;
import com.meilluer.infinity.databinding.ItemPostCard3TextBinding;
import com.meilluer.infinity.databinding.ItemPostCard3VideoTypeAutoplayBinding;
import com.meilluer.infinity.databinding.ItemPostCard3VideoTypeAutoplayLegacyControllerBinding;
import com.meilluer.infinity.databinding.ItemPostCard3WithPreviewBinding;
import com.meilluer.infinity.databinding.ItemPostCompact2Binding;
import com.meilluer.infinity.databinding.ItemPostCompact2RightThumbnailBinding;
import com.meilluer.infinity.databinding.ItemPostCompactBinding;
import com.meilluer.infinity.databinding.ItemPostCompactRightThumbnailBinding;
import com.meilluer.infinity.databinding.ItemPostGalleryBinding;
import com.meilluer.infinity.databinding.ItemPostGalleryGalleryTypeBinding;
import com.meilluer.infinity.databinding.ItemPostGalleryTypeBinding;
import com.meilluer.infinity.databinding.ItemPostTextBinding;
import com.meilluer.infinity.databinding.ItemPostVideoTypeAutoplayBinding;
import com.meilluer.infinity.databinding.ItemPostVideoTypeAutoplayLegacyControllerBinding;
import com.meilluer.infinity.databinding.ItemPostWithPreviewBinding;
import com.meilluer.infinity.events.PostUpdateEventToPostDetailFragment;
import com.meilluer.infinity.fragments.PostFragmentBase;
import com.meilluer.infinity.post.FetchStreamableVideo;
import com.meilluer.infinity.post.MarkPostAsReadInterface;
import com.meilluer.infinity.post.Post;
import com.meilluer.infinity.post.PostPagingSource;
import com.meilluer.infinity.thing.FetchRedgifsVideoLinks;
import com.meilluer.infinity.thing.SaveThing;
import com.meilluer.infinity.thing.StreamableVideo;
import com.meilluer.infinity.thing.VoteThing;
import com.meilluer.infinity.utils.APIUtils;
import com.meilluer.infinity.utils.GeminiHelper;
import com.meilluer.infinity.utils.HeadphoneManager;
import com.meilluer.infinity.utils.SharedPreferencesUtils;
import com.meilluer.infinity.utils.Utils;
import com.meilluer.infinity.videoautoplay.CacheManager;
import com.meilluer.infinity.videoautoplay.ExoCreator;
import com.meilluer.infinity.videoautoplay.ExoPlayerViewHelper;
import com.meilluer.infinity.videoautoplay.Playable;
import com.meilluer.infinity.videoautoplay.ToroPlayer;
import com.meilluer.infinity.videoautoplay.ToroUtil;
import com.meilluer.infinity.videoautoplay.media.PlaybackInfo;
import com.meilluer.infinity.videoautoplay.widget.Container;
...
public class PostRecyclerViewAdapter extends PagingDataAdapter<Post, RecyclerView.ViewHolder> implements CacheManager {
    ...
    private void openViewPostDetailActivity(Post post, int position) {
        if (canStartActivity) {
            ...
            if (mFragment instanceof com.meilluer.infinity.fragments.OfflinePostFragment) {
