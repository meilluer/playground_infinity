...
import com.meilluer.infinity.databinding.ItemFooterErrorBinding;
import com.meilluer.infinity.databinding.ItemFooterLoadingBinding;
import com.meilluer.infinity.databinding.ItemMessageBinding;
import com.meilluer.infinity.events.ChangeInboxCountEvent;
import com.meilluer.infinity.markdown.redditheading.RedditHeadingPlugin;
import com.meilluer.infinity.markdown.spoiler.SpoilerAwareMovementMethod;
import com.meilluer.infinity.markdown.spoiler.SpoilerParserPlugin;
import com.meilluer.infinity.markdown.superscript.SuperscriptPlugin;
import com.meilluer.infinity.message.FetchMessage;
            ...
            if (message != null) {
                ...
                holder.itemView.setOnClickListener(view -> {
                    ...
                    if (displayedMessage.isNew()) {
                        ...
                        int inboxCount = mActivity.getCurrentAccountSharedPreferences().getInt(com.meilluer.infinity.utils.SharedPreferencesUtils.INBOX_COUNT, 0);
                        inboxCount--;
                        if (inboxCount < 0) {
                            inboxCount = 0;
                        }
                        mActivity.getCurrentAccountSharedPreferences().edit().putInt(com.meilluer.infinity.utils.SharedPreferencesUtils.INBOX_COUNT, inboxCount).apply();
