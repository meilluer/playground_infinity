...
public class APIUtils {
    ...
    public static void init(Context context) {
        ...
        sUserAgent = preferences.getString("user_agent", "android:com.meilluer.infinity:\" + BuildConfig.VERSION_NAME + \" (by /u/Hostilenemy)");
    ...
    public static String sUserAgent = "android:com.meilluer.infinity:" + " (by /u/Hostilenemy)";
