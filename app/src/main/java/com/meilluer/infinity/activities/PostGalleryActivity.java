...
import com.meilluer.infinity.adapters.RedditGallerySubmissionRecyclerViewAdapter;
...
import com.meilluer.infinity.bottomsheetfragments.SelectOrCaptureImageBottomSheetFragment;
...
import com.meilluer.infinity.databinding.ActivityPostGalleryBinding;
import com.meilluer.infinity.events.SubmitGalleryPostEvent;
import com.meilluer.infinity.events.SwitchAccountEvent;
import com.meilluer.infinity.post.RedditGalleryPayload;
...
import com.meilluer.infinity.utils.UploadImageUtils;
        ...
        if (savedInstanceState != null) {
            ...
            if (getIntent().hasExtra(EXTRA_SUBREDDIT_NAME)) {
                ...
                if (getIntent().getBooleanExtra(EXTRA_IS_FLAIR_REQUIRED, false)) {
                    binding.flairCustomTextViewPostGalleryActivity.setText(getString(R.string.flair) + " (" + getString(R.string.required) + ")");
                }
                loadSubredditData();
            } else {
                ...
                subredditName, accessToken, new FetchSubredditData.FetchSubredditDataListener() {
                    ...
                    public void onFetchSubredditDataSuccess(SubredditData subredditData, int nCurrentOnlineSubscribers) {
                        ...
                        if (subredditData.isFlairRequired()) {
                            ...
                            if (flair == null) {
                                binding.flairCustomTextViewPostGalleryActivity.setText(R.string.flair);
                            }
                        }
