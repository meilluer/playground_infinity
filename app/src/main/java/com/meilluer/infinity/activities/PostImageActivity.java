...
import com.meilluer.infinity.databinding.ActivityPostImageBinding;
        ...
        if (savedInstanceState != null) {
            ...
            if (getIntent().hasExtra(EXTRA_SUBREDDIT_NAME)) {
                ...
                if (getIntent().getBooleanExtra(EXTRA_IS_FLAIR_REQUIRED, false)) {
                    binding.flairCustomTextViewPostImageActivity.setText(getString(R.string.flair) + " (" + getString(R.string.required) + ")");
                }
                loadSubredditData();
            } else {
                ...
                subredditName, accessToken, new FetchSubredditData.FetchSubredditDataListener() {
                    ...
                    public void onFetchSubredditDataSuccess(SubredditData subredditData, int nCurrentOnlineSubscribers) {
                        ...
                        if (subredditData.isFlairRequired()) {
                            ...
                            if (flair == null) {
                                binding.flairCustomTextViewPostImageActivity.setText(R.string.flair);
                            }
                        }
