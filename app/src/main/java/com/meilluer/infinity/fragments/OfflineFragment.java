...
import com.meilluer.infinity.adapters.OfflineSubredditAdapter;
import com.meilluer.infinity.bottomsheetfragments.DownloadOfflineSubredditBottomSheetFragment;
import com.meilluer.infinity.databinding.FragmentOfflineBinding;
import com.meilluer.infinity.offline.OfflineManager;
...
public class OfflineFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new OfflineSubredditAdapter(requireContext(), new OfflineSubredditAdapter.OnItemClickListener() {
            ...
            public void onItemClick(OfflineSubreddit offlineSubreddit) {
                Intent intent = new Intent(requireContext(), com.meilluer.infinity.activities.OfflinePostsActivity.class);
                intent.putExtra(com.meilluer.infinity.activities.OfflinePostsActivity.EXTRA_SUBREDDIT_NAME, offlineSubreddit.getName());
    ...
    private void startDownload(java.util.List<String> subredditNames, int postLimit, SortType.Type sortType, boolean downloadComments, int commentLimit, boolean downloadVideos, boolean downloadImages, boolean downloadText, String imageQuality, String videoQuality) {
        ...
        String token = "";
        if (getActivity() instanceof com.meilluer.infinity.activities.MainActivity) {
             token = ((com.meilluer.infinity.activities.MainActivity) getActivity()).getAccessToken();
        }
