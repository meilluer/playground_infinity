...
import com.meilluer.infinity.databinding.FragmentCommentMoreBottomSheetBinding;
...
import com.meilluer.infinity.utils.ShareScreenshotUtilsKt;
        ...
        binding.followTextViewCommentMoreBottomSheetFragment.setOnClickListener(view -> {
            new Thread(() -> {
                ...
                if (followedThing != null) {
                    ...
                    LiveActivityUtils.enableLiveActivity(activity);
                    ...
                    LiveActivityUtils.showCachedNotification(activity, mRedditDataRoomDatabase.followedThingDao().getAllFollowedThings(), newFollowedThing);
